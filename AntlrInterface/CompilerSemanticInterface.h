...
class CompilerSemanticInterface {
    ...
    void diferentialProfilesMORPHOLOGICAL(const string& inputFileName, vector<double> values, string& outputFileNamePartially) const; //DONE
    void diferentialProfilesATTRIBUTE(const string& inputFileName, vector<double> values, string& outputFileNamePartially) const;     //DONE
    void mappingDMP(const string& inputFileName, vector<double> values, string& outputFileNamePartially) const;					      //DONE 
    void mappingDAP(const string& inputFileName, vector<double> values, string& outputFileNamePartially) const;					      //DONE 
