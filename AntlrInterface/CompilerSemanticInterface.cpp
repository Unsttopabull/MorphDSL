...
void CompilerSemanticInterface::StoreFile(const string& filePath, vector<vector<double>>& img) const {
    ...
    int sizeX = img.size();
    fwrite(&sizeX, sizeof(int), 1, file);

    int sizeY = img[0].size();
    fwrite(&sizeY, sizeof(int), 1, file);
...
void CompilerSemanticInterface::StoreFile(const string& filePath, vector<vector<vector<double>>>& img) const {
    ...
    int sizeZ = img[0][0].size();
    fwrite(&sizeZ, sizeof(int), 1, file);
...
void CompilerSemanticInterface::diferentialProfilesMORPHOLOGICAL(const string& inputFileName, vector<double> values, string& outputFileNamePartially) const {
    vector<vector<double>> img;
    LoadImg(inputFileName, img);
...
void CompilerSemanticInterface::diferentialProfilesATTRIBUTE(const string& inputFileName, vector<double> values, string& outputFileNamePartially) const {
    vector<vector<double>> img;
    LoadImg(inputFileName, img);
    ...
    tree.Parameter2Img(dap_line);

    CropData(dap_line, 0.0, 10.0);
...
void CompilerSemanticInterface::mappingDMP(const string& inputFileName, vector<double> values, string& outputFileNamePartially) const {
    vector<vector<double>> img;
    LoadImg(inputFileName, img);
...
void CompilerSemanticInterface::mappingDAP(const string& inputFileName, vector<double> values, string& outputFileNamePartially) const {
    vector<vector<double>> img;
    LoadImg(inputFileName, img);
...
void CompilerSemanticInterface::erodeRECONSTRUCTION(const string& inputFileName1, const string& inputFileName2, const string& outputFileName) const {
    ...
    MMLibG2D mmg;
    LoadImg(inputFileName2, mmg.data);
    InvertData(mmg.data);
    mmg.Init();
